    ...
    <main>
        <div>
            <div style="margin-left: 266px; margin-bottom:6px; margin-top:-10px">
                <a href="{{ route('Admin.xemlichsap') }}"><i style="color:rgb(99, 96, 96); font-size:20px;"
        ...
        <form action="{{ route('Admin.editlichsap', ['id' => $lichtruc->lt_Id]) }}" method="POST">
            @csrf
            <input type="hidden" name="user_id" value="{{ $lichtruc->user_id }}">
            <table class="table table-striped" style="width: 60%; margin: 0 auto; height:370px">
                <tbody>
                    <tr>
                        <td style="vertical-align: top; padding-top: 16px;">
                            <label for="doctor_name">Tên Bác Sĩ:</label>
                            <input type="text" class="form-control" name="lt_tenbs" value="{{ $lichtruc->lt_tenbs }}"
                                required>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top; padding-top: 12px;">
                            ...
                            <input type="date" id="schedule_date" class="form-control" name="lt_Ngaytruc"
                                style="width:100%;" value="{{ $lichtruc->lt_Ngaytruc }}" required>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top; padding-top: 12px;">
                            ...
                            <div style="text-align:center; margin:12px">
                                @php
                                    $selectedTimes = explode(', ', $lichtruc->lt_Giotruc);
                                @endphp
                    ...
                    <tr>
                        <td style="text-align: center; padding-top: 35px;">
                            <button type="submit" class="btn btn-light">Sửa Lịch Sắp</button>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div style="text-align: center; margin-top: 12px;">
            <p style="font-size: 13px;">
                Vui lòng chỉ sắp lịch trực trong một tuần. Không sắp hai tuần liên tiếp!
